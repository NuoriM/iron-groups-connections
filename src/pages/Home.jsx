          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="flex items-center gap-3 mb-8 px-4 py-3 rounded-xl border border-yellow-900/40 bg-yellow-950/20 text-yellow-500/80">
              ...
              <p className="text-sm">
                ...
                refletem um snapshot da comunidade coletado no dia 11/03/2026.
              </p>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-400 leading-relaxed">
                <p>
                  O Iron Hotel não é só um jogo, é uma comunidade que sobreviveu
                  ao fim do Flash, às mudanças do mercado e ao tempo. Mais de 12
                  anos de histórias, amizades e grupos que moldaram a cultura de
                  um dos Habbos piratas mais longevos da língua portuguesa.
                </p>
                <p>
      ...
      <section className="bg-gray-950 border-t border-red-950/30 py-20 text-center">
        <div className="mx-auto max-w-xl px-6">
          ...
          <p className="mt-10 text-xs text-gray-600 uppercase tracking-widest">
            Seu grupo não aparece?
          </p>
          <a
            href="mailto:nuorim.contato@gmail.com"
            className="mt-3 inline-flex items-center gap-2 text-sm text-red-500 hover:text-red-400 transition-colors"
          >
            <i className="pi pi-envelope" />
            Pedir inclusão por e-mail
          </a>
        </div>
      </section>
    </MainLayout>
